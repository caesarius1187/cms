...
class ProductosController extends AppController
{
    ...
    {
        $producto = $this->Productos->get($id, contain: ['Rubros', 'Detallecompras', 'Detallepromotions', 'Detalleventas', 'Promotions']);
    ...
    public function add()
    {
        ...
        $rubros = $this->Productos->Rubros->find('list', limit: 200)->all();
